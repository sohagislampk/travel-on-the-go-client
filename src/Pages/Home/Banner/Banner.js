            ...
            <div className="h-56 lg:h-96">
                <Carousel>
                    <div className="flex flex-col h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white banner-1 banner-overlay">
                        <h3 className='text-lg text-white z-50' >Experiences The Largest See Beach</h3>
                        <h1 className='text-white text-5xl z-50 my-6' >Bangladesh Is Open For Travel</h1>
                    ...
                    <div className="flex flex-col h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white banner-2 banner-overlay">
                        <h3 className='text-lg text-white z-50' >See World Like Never before</h3>
                        <h1 className='text-white text-5xl z-50 my-6' >Travel with Travel On The Go</h1>
                        <div className='z-50 mt-6'>
                            <Button gradientDuoTone="greenToBlue">
                                Explor The Packages
                            </Button>
                    ...
                    <div className="flex flex-col h-full items-center justify-center bg-gray-400 dark:bg-gray-700 dark:text-white banner-3 banner-overlay">
                        <h3 className='text-lg text-white z-50' >Travel is your therapy</h3>
                        <h1 className='text-white text-5xl z-50 my-6' >Dare to live the life you've always wanted</h1>
                        <div className='z-50 mt-6'>
                            <Button gradientDuoTone="greenToBlue">
                                Explor The Packages
                            </Button>
